...
| <a name="input_frontend_subnet_name"></a> [frontend\_subnet\_name](#input\_frontend\_subnet\_name)                                                           | (Optional) Frontend virtual network name to use when in private mode. Ignored if `frontend_subnet_id` is set.                                                                                                                                                                                                                                                                                                                                                                                                        | `string`       | `""`                                         |    no    |
| <a name="input_frontend_vnet_name"></a> [frontend\_vnet\_name](#input\_frontend\_vnet\_name)                                                                 | (Optional) Frontend virtual network name to use when in private mode. Ignored if `frontend_subnet_id` is set.                                                                                                                                                                                                                                                                                                                                                                                                        | `string`       | `""`                                         |    no    |
